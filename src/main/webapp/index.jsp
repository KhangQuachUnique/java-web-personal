      ...
      <section id="homeworks" class="homeworks">
        ...
        <div class="homeworks-grid">
          ...
          <div class="homework-card">
            ...
            <p>Bai tap 3 (26/8)</p>
            <a
              href="${pageContext.request.contextPath}/survey"
              class="btn btn-primary"
              >View Details</a
            >
          </div>
          ...
          <div class="homework-card">
            ...
            <p>Bai tap 5 (4/9) (Chuong 6)</p>
            <a
              href="${pageContext.request.contextPath}/emailList"
              class="btn btn-primary"
              >View Details</a
            >
          </div>
          <div class="homework-card">
            ...
            <p>Bai tap 5 (4/9) (Chuong 6)</p>
            <a
              href="${pageContext.request.contextPath}/ch06_ex2"
              class="btn btn-primary"
              >View Details</a
            >
          </div>
          <div class="homework-card">
            ...
            <p>Bai tap 6 (5/9) (Chuong 8)</p>
            <a href="https://ch8-ex1-x4q6.onrender.com/" class="btn btn-primary"
              >View Details</a
            >
          </div>
          <div class="homework-card">
            <h3>Assignment 6 (9.1)</h3>
            <p>Bai tap 6 (5/9) (Chuong 9)</p>
            <a
              href="https://ch09-ex1-8wn1.onrender.com/"
              class="btn btn-primary"
              >View Details</a
            >
          </div>
          <div class="homework-card">
            ...
            <p>Bai tap 6 (5/9) (Chuong 9)</p>
            <a href="https://ch9-ex2-m9jr.onrender.com/" class="btn btn-primary"
              >View Details</a
            >
          </div>
          <div class="homework-card">
            <h3>Assignment 7 (7.1)</h3>
            <p>Bai tap 7 (9/9) (Chuong 7)</p>
            <a href="https://ch7-ex1-2ilo.onrender.com/" class="btn btn-primary"
              >View Details</a
            >
          </div>
          <div class="homework-card">
            ...
            <p>Bai tap 7 (9/9) (Chuong 7)</p>
            <a href="https://ch7-ex2-h2rx.onrender.com/" class="btn btn-primary"
              >View Details</a
            >
          </div>
          <div class="homework-card">
            ...
            <p>Bai tap 7 (9/9) (Chuong 7)</p>
            <a href="https://ch7-ex3-hagq.onrender.com/" class="btn btn-primary"
              >View Details</a
            >
          </div>
          <div class="homework-card">
